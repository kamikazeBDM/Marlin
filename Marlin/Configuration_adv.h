 ...
 */
// **24, *30 *38, 60Hz, 122, 244, 977 (whines as gets higher) works - no ocra - no softpwm |  DOES NOT WORK: 1.95Khz 4412, 7.8Khz
#if ENABLED(FAST_PWM_FAN)
  #define FAST_PWM_FAN_FREQUENCY 488  // 24  2206 (2.205882352941176) ||  // 4412 (4.411764705882353)  || 17647  (17.64705882352941) || 35294 (35.29411764705882)
...
//#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_PIN PC13                  // Override the default pin if needed
...
#define HOMING_BACKOFF_POST_MM { 2, 2, 7 }  // (mm) Backoff from endstops after homing
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      565  // (mm) The length of filament for a complete unload.
