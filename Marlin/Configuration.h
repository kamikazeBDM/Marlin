 ...
 * 
 * -1 =                Bootloader  Built in USB on BTT OCTOPUS PRO V1.0
 *  1 = TFT          - BTT OCTOPUS PRO V1.0 USART1 TFT
 *  2 = USART2       - RASPBERRY PI 3/4b - OCTOPRINT
 *  3 = WiFi         - WiFi Module?
 *  4 = ??
 *  5 = ??
 *  6 = ??           - WiFi module?
...
//  [ WiFi ]     BTT OCTOPUS PRO V1.0 
//                WiFi Module
//#define SERIAL_PORT_3 3   // or 6?
...
// HC-89 (B07JMDLD84)         Set true  as this is active LOW 
// LM393 H2010 (B01HXU1WME)   set false as this circuit is active HIGH
...
#define DEFAULT_AXIS_STEPS_PER_UNIT  { 80.300, 80.300, 400.310, 394.500, 394.500 }
...
#define DEFAULT_MAX_FEEDRATE          { 150.00, 150.00, 12, 500, 500 }
...
#define DEFAULT_MAX_ACCELERATION      { 1500, 2000, 100, 10000, 10000 }
...
// *******************************************
// comment out when using BTT TFT35 E3 V3.0
// enable to use stock Ender 3 Pro 12864
// *******************************************
